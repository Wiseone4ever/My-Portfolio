...
#Part 1.2 - SQL Database Schema Creation 
>>>>>>> 83af47df161d1718e6a3ffa8896826843d366024
>>>>>>> b1b8406d6719cacb0a4998c7b013a6882c5acc9f
...
<<<<<<< HEAD
      delivered_timestamp = dispatch_timestamp + days(sample(2:5, n()
=======
...
=======
=======
    existing_ids <- dbGetQuery(my_connection, sprintf("SELECT category_id FROM 
                PRODUCT_CATEGORY WHERE category_id = '%s'", df$category_id[i]))
    if(nrow(existing_ids) > 0) {
      cat(sprintf("Skipping duplicate entry for category_id: %s\n"
                  , df$category_id[i]))
      next
...
=======
=======
  required_columns <- c("product_id", "stock_quantity"
